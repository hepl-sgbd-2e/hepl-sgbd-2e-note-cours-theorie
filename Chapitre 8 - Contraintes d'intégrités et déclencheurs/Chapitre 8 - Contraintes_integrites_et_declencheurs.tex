...
\begin{frame}{\secname : \subsecname}
    \lstinputlisting[language=sql, title=Exemple]{../exemples/Chapitre 8/DEFERRABLE.sql}
...
\begin{frame}{\secname : \subsecname}
    \lstinputlisting[language=sql, title=Exemple]{../exemples/Chapitre 8/DEFERRABLE2.sql}
...
\subsection{Exemple}
\begin{frame}{\secname : \subsecname}
    \lstinputlisting[language=sql, title=Exemple : contrainte dynamique]{../exemples/Chapitre 8/contrainte-dynamique.sql}
...
\begin{frame}[allowframebreaks]{\secname : \subsecname}
    ...
    \lstinputlisting[language=sql, title=Exemple: gestion automatique de la redondance]{../exemples/Chapitre 8/redondance.sql}
...
\begin{frame}{\secname : \subsecname}
    \lstinputlisting[language=sql, title=Exemple: gestion automatique de la redondance]{../exemples/Chapitre 8/redondance2.sql}
\end{frame}
...
\begin{frame}{\secname : \subsecname}
    \lstinputlisting[language=sql, title=Exemple : mise à jour en cascade]{../exemples/Chapitre 8/redondance3.sql}
\end{frame}
\end{document}