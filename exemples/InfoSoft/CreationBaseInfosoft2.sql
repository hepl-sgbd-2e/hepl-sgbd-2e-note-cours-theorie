...
values ('123456', 'CURTIS', 'Tony',	 to_date('1930-02-17' ,'YYYY-MM-DD'),'M',
	'rue Egalite, 18','4430','ANS',70000); 
insert into employes
(NumSecu, Nom, Prenom, DateNais, Sexe, Adresse, CodePostal, Commune,Bareme)
values ('451278', 'CELARIE', 'Clementine',
to_date('1960-10-10' ,'YYYY-MM-DD'),'F',
	'rue Tige, 7','4040','HERSTAL',
	80000); 
insert into employes
(NumSecu, Nom, Prenom, DateNais, Sexe, Adresse, CodePostal, Commune,Bareme)
values ('654321','BEART', 'Emmanuelle',
	 to_date('1965-04-04' ,'YYYY-MM-DD'),'F',
...
values ('p10345', 'Intranet',
         to_date('2012-01-05' ,'YYYY-MM-DD'), 'SERAING', 'd00003');
insert into projets 
values ('p10346', 'Gihep',
         to_date('2012-09-12' ,'YYYY-MM-DD'), 'LIEGE', 'd00004');
insert into projets 
values ('p10347', 'Eole',
         to_date('2012-02-01' ,'YYYY-MM-DD'), 'LONDON', 'd00004');
insert into projets 
values ('p10348', 'E-commerce',
         to_date('2012-01-15' ,'YYYY-MM-DD'), 'SERAING', 'd00001');
insert into projets 
values ('p10349', 'Web',
         to_date('2012-06-13' ,'YYYY-MM-DD'), 'LIEGE', 'd00002');
insert into projets 
values ('p10350', 'Gps - Cartographie',
         to_date('2012-05-19' ,'YYYY-MM-DD'), 'LIEGE', 'd00002');
insert into projets 
values ('p10351', 'Email',
         to_date('2012-02-13' ,'YYYY-MM-DD'), 'LIEGE', 'd00001');
insert into projets 
values ('p10352', 'Jeux - Divertissements',
         to_date('2012-03-19' ,'YYYY-MM-DD'), 'LIEGE', 'd00002');
